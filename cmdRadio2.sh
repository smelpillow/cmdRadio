#!/bin/bash
musicFolder="$HOME/GitHub/cmdRadio/InternetRadio"
m3uFiles=($(find "$musicFolder" -type f -name "*.m3u" -exec basename {} \; | sort))
...
while true; do
 ...
 mpv --shuffle --config-dir="$HOME/GitHub/cmdRadio/mpv" "$selectedFile"
